...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    train_loader, dataset = create_dataloader(train_path, imgsz, batch_size // WORLD_SIZE, gs, names, single_cls,
                                              ...
                                              prefix=colorstr('train: '), shuffle=True, preserve_orientation=opt.preserve_orientation)
...
def parse_opt(known=False):
    ...
    parser.add_argument('--preserve_orientation', action='store_true', help='whether the training data polygon is oriented clockwise from top left corner')
